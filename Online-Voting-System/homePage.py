...
def Home(root, frame1, frame2):
    ...
    #root.title("Home")
    # img =Image.open('C:\\Users\\Kavin\\Desktop\\Online-Voting-System\\img\\logo.jpg')
    ...
    #Admin Login
    admin = Button(frame1, text="Admin Login", width=15, command = lambda: AdmLogin(root, frame1),bg="#FF671F")
   
    #Voter Login
    voter = Button(frame1, text="Voter Login", width=15, command = lambda: voterLogin(root, frame1),bg="#FFFFFF")

    #New Tab
    newTab = Button(frame1, text="New Window", width=15, command = lambda: sb_p.call('start python homePage.py', shell=True),bg="#046A38")
